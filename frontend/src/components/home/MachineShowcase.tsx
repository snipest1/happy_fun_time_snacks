...
import { ArrowRight, ArrowLeft, Monitor, CreditCard, UserPlus, LineChart } from 'lucide-react';

const machines = [
  {
    id: 1,
    name: "Premium Snack Vending",
    description: "Our flagship snack vending machine with 40+ product selections, touchscreen interface, and cashless payment options.",
    image: "https://picsum.photos/id/96/800/600",
    features: ["Touchscreen Interface", "Cashless Payment", "Remote Monitoring", "Custom Branding"],
  ...
  },
  {
    ...
    description: "Temperature-controlled beverage machine with 8 selections of cold drinks and real-time inventory tracking.",
    image: "https://picsum.photos/id/225/800/600",
    features: ["Temperature Control", "Energy Efficient", "Illuminated Display", "Remote Monitoring"],
  ...
  },
  {
    id: 3,
    name: "Combo Deluxe",
    description: "The ultimate solution combining snacks and beverages in one unit with customizable temperature zones.",
    image: "https://picsum.photos/id/180/800/600",
    features: ["Dual Zones", "Touchscreen Interface", "Custom Product Mix", "Energy Efficient"],
    capacity: "40 Snacks + 160 Beverages",
    dimensions: "72\"H x 72\"W x 36\"D"
  },
  {
    id: 4,
    name: "Micro Market",
    description: "Self-service mini convenience store with open shelving, refrigerated section, and self-checkout kiosk.",
    image: "https://picsum.photos/id/119/800/600",
    features: ["Open Design", "Self-Checkout", "Wide Selection", "Fresh Options"],
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our range of cutting-edge vending machines designed for reliability, 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-transparent flex items-end">
              <div className="p-6">
                <h3 className="text-white text-2xl font-bold">{currentMachine.name}</h3>
          ...
          {/* Machine Details */}
          <div className="p-6">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">{currentMachine.name}</h3>
            ...
            <div className="mb-8">
              ...
              <p><span className="font-medium">Dimensions:</span> {currentMachine.dimensions}</p>
              <p><span className="font-medium">Capacity:</span> {currentMachine.capacity}</p>
            </div>
